...
<img src = ".screenshots/magnify_modpack_standard_viewer.png" alt = "Species viewer" width = "480" height = "250"> <img src = ".screenshots/magnify_modpack_technical_viewer.png" alt = "Technical viewer" width = "480" height = "250"> <img src = ".screenshots/magnify_modpack_technical_locator.png" alt = "Species locator" width = "480" height = "250">
...
Additionally, you can specify an initial `x` and `y` rotation for your model using the `model_rot_x` and `model_rot_y` properties, respectively.
